/**
 * Full Better Auth schema for the local component installation.
 * Includes base tables + organization plugin tables.
 *
 * Re-generate with:
 *   npx @better-auth/cli generate --config ./convex/betterAuth/auth.ts \
